...
var splitArray = function (nums, m) {
  ...
  const combinelow = (source) => {
    ...
    let minimum = sumCache.reduce((a, b) => Math.min(a, b));
    const startIndex = indexCache[minimum];
    source.splice(startIndex, 2, minimum);
    return source;
  };
  ...
  return step.reduce((a, b) => Math.max(a, b));
};
